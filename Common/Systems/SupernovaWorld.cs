	...
	public class SupernovaWorld : ModSystem
	{
        ...
        public override void ModifyWorldGenTasks(List<GenPass> tasks, ref float totalWeight)
        {
            ...
            if (ShiniesIndex != -1)
            {
                ...
                tasks.Insert(ShiniesIndex + 1, new PassLegacy("World Gen Supernova Ores", WorldStartGenOres));
            }
        }

        private void WorldStartGenOres(GenerationProgress progress, GameConfiguration configuration)
		{
        ...
        private void WorldGenZirconiumOre()
		{
