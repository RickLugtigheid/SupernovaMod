...
namespace Supernova.Content.PreHardmode.Items.Misc
{
    public class HorridChunk : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            bool alreadySpawned = NPC.AnyNPCs(ModContent.NPCType<Bosses.FlyingTerror.FlyingTerror>());
        ...
        public override bool? UseItem(Player player)/* tModPorter Suggestion: Return null instead of false */
        {
            ...
            NPC.SpawnOnPlayer(player.whoAmI, ModContent.NPCType<Bosses.FlyingTerror.FlyingTerror>()); // Spawn the boss within a range of the player. 
