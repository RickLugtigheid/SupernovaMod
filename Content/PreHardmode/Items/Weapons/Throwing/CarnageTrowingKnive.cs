...
namespace Supernova.Content.PreHardmode.Items.Weapons.Throwing
{
    public class CarnageTrowingKnive : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shootSpeed = 11f;
            Item.shoot = ModContent.ProjectileType<Global.Projectiles.Thrown.CarnageTrowingKniveProj>();
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Materials.BloodShards>(), 3);
            recipe.AddIngredient(ModContent.ItemType<Materials.BoneFragment>(), 1);
