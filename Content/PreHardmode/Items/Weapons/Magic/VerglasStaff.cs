...
namespace Supernova.Content.PreHardmode.Items.Weapons.Magic
{
    public class VerglasStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Content.Global.Projectiles.Summon.VerglasFlakeMinion>();
            Item.shootSpeed = 1f;
            Item.buffType = ModContent.BuffType<Global.Buffs.Minion.VerglasFlakeBuff>();
            Item.buffTime = 3600;
