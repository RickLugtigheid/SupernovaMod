        ...
        private int GetProjectileForAmmo()
        {
            switch (_ammoItemId)
            {
                case ItemID.CrimsandBlock:
                    return ModContent.ProjectileType<Global.Projectiles.Ranged.Bullets.CrimsandBullet>();
                case ItemID.EbonsandBlock:
                    return ModContent.ProjectileType<Global.Projectiles.Ranged.Bullets.EbonsandBullet>();
                case ItemID.PearlsandBlock:
                    return ModContent.ProjectileType<Global.Projectiles.Ranged.Bullets.PearlsandBullet>();
                default: // Default & ItemID.SandBlock
                    return ModContent.ProjectileType<Global.Projectiles.Ranged.Bullets.SandBullet>();
            }
        }
    }
}