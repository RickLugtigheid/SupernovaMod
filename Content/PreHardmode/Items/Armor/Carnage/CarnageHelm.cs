...
namespace Supernova.Content.PreHardmode.Items.Armor.Carnage
{
    ...
    public class CarnageHelm : ModItem
    {
        ...
        public override void UpdateArmorSet(Player player)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Global.Projectiles.Summon.CarnageOrb>()] < 1)
			{
                Projectile.NewProjectile(player.GetSource_Misc("SetBonus_CarnageArmor"), player.position, Microsoft.Xna.Framework.Vector2.Zero, ModContent.ProjectileType<Global.Projectiles.Summon.CarnageOrb>(), 18, 1, player.whoAmI);
            }
        }
