...
namespace Supernova.Content.Npcs.Bosses.FlyingTerror
{
    public class TerrorBreath : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int num2361 = Dust.NewDust(position43, width31, height31, DustID.Torch, x10, y8, 100, default, 3f * Projectile.scale);
            ...
            for (int num1438 = 0; num1438 < 2; num1438 = num2475 + 1)
            {
                if (!Main.rand.NextBool(3))
                {
                    ...
                    int dustID = Dust.NewDust(position179, width139, height139, 170, 0f, 0f, 100, default, 1f);
            ...
            {
                int num148 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Torch, (0f - Projectile.velocity.X) * 0.2f, (0f - Projectile.velocity.Y) * 0.2f, 100, default, 2f * Projectile.scale);
                Main.dust[num148].noGravity = true;
                Dust dust24 = Main.dust[num148];
                dust24.velocity *= 2f;
                num148 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.Torch, (0f - Projectile.velocity.X) * 0.2f, (0f - Projectile.velocity.Y) * 0.2f, 100, default, 1f * Projectile.scale);
