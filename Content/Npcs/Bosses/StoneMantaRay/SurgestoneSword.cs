    ...
    public class SurgestoneSword : ModItem
    {
        ...
        public override void OnHitNPC(Player player, NPC target, int damage, float knockBack, bool crit)
        {
            ...
            if (i > 6)
            {
                ...
                Projectile.NewProjectile(Item.GetSource_FromAI(), target.position.X, target.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ProjectileID.SandnadoFriendly, Item.damage / 2, 4f, player.whoAmI);
                i = 0;
            }
        }
    }
