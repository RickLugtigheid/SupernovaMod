...
namespace Supernova.Content.Global.Projectiles.Thrown
{
    public class KunaiProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                item = Item.NewItem(Projectile.GetSource_DropAsItem(), Projectile.position, Projectile.width, Projectile.height, ModContent.ItemType<PreHardmode.Items.Weapons.Throwing.Kunai>(), 1, false, 0, false, false);
            }
