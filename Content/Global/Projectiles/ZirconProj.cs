    ...
    public class ZirconProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] > 3f)
            {
                ...
                {
                    int num92 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Dusts.ZirconDust>(), Projectile.velocity.X, Projectile.velocity.Y, 100, default(Color), Scale: 1.5f);
