...
namespace Supernova.Content.Global.Projectiles.Magic
{
    public class ZicroniumSpark : ModProjectile
    {
		...
		public override void AI()
		{
			...
			int num199 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, dustId, 0f, 0f, 100, default(Color), 1f);
			...
			{
				int num200 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, dustId, 0f, 0f, 100, default(Color), 1f);
