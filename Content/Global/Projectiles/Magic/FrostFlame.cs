        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] > 12f)  //this defines where the flames starts
            {
                if (Main.rand.NextBool(3))     //this defines how many dust to spawn
                {
                    ...
                    int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 59, Projectile.velocity.X * 1.2f, Projectile.velocity.Y * 1.2f, 130, default, 4.75f);   //this defines the flames dust and color, change DustID to wat dust you want from Terraria, or add mod.DustType("CustomDustName") for your custom dust
