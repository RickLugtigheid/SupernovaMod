...
namespace Supernova.Content.Global.Projectiles.Magic
{
    public class GlowGunProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int DustID2 = Dust.NewDust(Projectile.position, Projectile.width * 2, Projectile.height * 2, DustID.GlowingMushroom, Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, 20, default, Main.rand.NextFloat(.6f, 1.75f));
