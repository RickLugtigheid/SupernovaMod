...
namespace Supernova.Content.Global.Projectiles
{
    public class CarnageScepterProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int DustID2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y + 5f), Projectile.width + 2, Projectile.height + 2, ModContent.DustType<Dusts.BloodDust>(), Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 20, default(Color), 1.2f);
