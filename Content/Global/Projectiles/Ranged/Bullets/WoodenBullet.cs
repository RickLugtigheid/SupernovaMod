...
namespace Supernova.Content.Global.Projectiles.Ranged.Bullets
{
    public class WoodenBullet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 0, Projectile.velocity.X * -0.6f, Projectile.velocity.Y * 1.2f, 80, default, 0.75f);
