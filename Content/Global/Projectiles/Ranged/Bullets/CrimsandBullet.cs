...
namespace Supernova.Content.Global.Projectiles.Ranged.Bullets
{
	public class CrimsandBullet : SandBullet
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, DustID.CrimtaneWeapons, Projectile.velocity.X * -0.6f, Projectile.velocity.Y * 1.2f, 80, default(Color), 0.75f);
