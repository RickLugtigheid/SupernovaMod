...
namespace Supernova.Content.Global.Projectiles
{
    public class CarnageTrowingKniveProj : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int x = 0; x <= 7; x++)
            {
                int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Bone, -Projectile.velocity.X, -Projectile.velocity.Y, 80, default(Color), 1);   //this defines the flames dust and color, change DustID to wat dust you want from Terraria, or add mod.DustType("CustomDustName") for your custom dust
            ...
            {
                item = Item.NewItem(Projectile.GetSource_DropAsItem(), Projectile.position, ModContent.ItemType<PreHardmode.Items.Weapons.CarnageTrowingKnive>());
            }
