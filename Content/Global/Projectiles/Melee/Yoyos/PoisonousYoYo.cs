...
namespace Supernova.Content.Global.Projectiles.Melee.Yoyos
{
    public class PoisonousYoYo : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int DustID2 = Dust.NewDust(Projectile.position, Projectile.width + 2, Projectile.height + 2, 44, Projectile.velocity.X * 0.25f, Projectile.velocity.Y * 0.25f, 80, default, 1);
                Main.dust[DustID2].noGravity = true;
                DustID2 = Dust.NewDust(Projectile.position, Projectile.width + 2, Projectile.height + 2, 46, Projectile.velocity.X * 0.5f, Projectile.velocity.Y * 0.5f, 80, default, 1.4f);
                Main.dust[DustID2].noGravity = true;
            }
        }
