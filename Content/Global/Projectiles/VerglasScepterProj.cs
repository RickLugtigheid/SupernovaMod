...
namespace Supernova.Content.Global.Projectiles
{
    public class VerglasScepterProj : ModProjectile
    {
        ...
        public override void AI()
        {
			...
			{
                int DustID2 = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.Frost, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 20, default(Color), Main.rand.NextFloat(.85f, 1.35f));
